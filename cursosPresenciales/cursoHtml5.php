...
<!-- ESTRUCTURA DEL FUTURO SLIDER Y ADEMAS DE LA FOTO CD SEA FIJA -->
		...
		<div class="main inner-block fondoBlanco detalleCurso">
			<ul>
              ...
              <li>
                  ...
                  <div class="texto_dcha">
                      <p>
                          Aprender HTML en <strong>forma sencilla</strong> viendo un concepto teórico, luego algunos ejercicios resueltos y por último y lo más importante desarrollar otros por usted mismo
                      </p>
                      <p>
                          HTML es el <strong>lenguaje más básico</strong> para la creación de páginas web. Es usado para definir la estructutra y el contenido en forma de texto y complementar el texto de páginas web con imágenes, tablas y formularios. HTML se escribe en forma de «etiquetas». Este curso <strong>permite aprender </strong>los fundamentos para la creación de páginas web usando HTML.
                      </p>
                  </div>
              </li>
              <li>
                  ...
                  <div class="texto_dcha">
                      <ol class="lista_numeros">
                          ...
                          <li>
                                  ...
                                  Hipervínculos en html. listas en html. tablas en html.
