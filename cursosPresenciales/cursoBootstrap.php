...
<title>Curso Bootstrap | Cursos Presenciales | Nuestros cursos | Webstudy.com</title>
...
<div class="header">
   ...
   <div class="destacado_principal slider">
    ...
    <img alt="" src="../img/imgSlider/bootstrapSlider.png">
 </div>
	</div>
	</div>
    ...
    <div class="contenedor top-block"> 
        <div class="info-box">
            <div class="introCursos row">
                <p>Bootstrap es un framework o conjunto de herramientas de software libre para diseño de sitios y aplicaciones web.
                ...
                <p> Es el proyecto más popular en GitHub y es usado por la NASA y la MSNBC junto a demás organizaciones</p>
            </div>
        </div>
    </div>	
        ...
        <ul>
            <li>
                ...
                <div class="texto_dcha">
                    <p><strong>
                            Del 1 de noviembre al 10 diciembre
                        </strong>
                    </p>
            ...
            <li>
                ...
                <div class="texto_dcha">
                    <p><strong>
                            105 horas de dedicación efectiva, incluyendo lecturas, estudio y ejercicios.
                        </strong>
                    </p><p>(se estiman 48 dias dedicando 3 horas diarias)</p>
                </div>
            </li>
            <li>
                <div class="iconoCurso">
            ...
            <li>
                ...
                <div class="texto_dcha">
                    <ol class="lista_numeros">
                        <li>Primeros pasos. Contenidos de Bootstrap</li>
                        <li>Diseñando con rejillas</li>
                        <li>Elementos para el Css </li>
                        <li>Formularios</li>
                        <li>Componetes</li>
                    </ol>
                </div>
