<?php include("../include/inc_1_head_inicio_subcarpeta.php") ?>
	...
	<title>Curso Blog | Cursos Presenciales | Nuestros cursos | Webstudy.com</title>
		...
		<div class="contenedor top-block"> 
			<div class="info-box">
                <div class="introCursos row">
                    <p>La Programación Orientada a Objetos es el paradigma de programación más utilizado en la actualidad.</p>
                    <p> Su consistente base teórica y la amplia gama de herramientas que permiten crear código a través de diseños orientados a objetos la convierten en la alternativa más adecuada para el desarrollo de aplicaciones.</p>
                </div>
            </div>
		</div>	
		<div class="main inner-block fondoBlanco detalleCurso">
			<ul>
              ...
              <li>
                  ...
                  <div class="texto_dcha">
                      <p><strong>
                        95 horas de dedicación efectiva, incluyendo lecturas, estudio y ejercicios.
                      </strong>
                  ...
                  <div class="texto_dcha">
                      <ol class="lista_numeros">
                          <li>
                                ...
                                Introducción a la Programación Orientada a Objeto. Uso de Estándares y Repaso de Programación Estructurada.
                              
                          </li>
                          <li>
                              
                                  Clases y Objetos. Clases y Funciones Amigas. Sobrecarga de Funciones.
                              
                          </li>
                          <li>
                              
                                  	Creación Dinámica de Objetos. Herencia. Polimorfismo.  
                              
                          </li>
                          <li>
                              
                                 Clases con atributos dinámicos. Operadores y retorno con this y operadores globales.
