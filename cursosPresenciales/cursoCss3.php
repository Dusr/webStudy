...
<title>Curso Css3 | Cursos Presenciales | Nuestros cursos | Webstudy.com</title>
    ...
    <div class="contenedor top-block"> 
        <div class="info-box">
            <div class="introCursos row">
                <p>HTML5 es el lenguaje estándar, aprobado por la W3C, que <strong> se emplea para crear páginas web</strong>. Este curso, estudia a fondo el estándar y algunas de las extensiones de los navegadores más utilizados. </p>
            </div>
        </div>
    </div>	
        ...
        <ul>
            <li>
                ...
                <div class="texto_dcha">
                    <p><strong>
                            Del 28 de mayo al 10 julio
                        </strong>
                    </p>
                    <p>Disponible : turno mañana , turno fin de semana</p>
                </div>
            </li>
            <li>
                <div class="iconoCurso">
                ...
                <div class="texto_dcha">
                    <p><strong>
                            50 horas de dedicación efectiva, incluyendo lecturas, estudio y ejercicios.
                        </strong>
                    </p><p>(se estiman 20 dias dedicando 3 horas diarias)</p>
                </div>
            </li>
            <li>
                <div class="iconoCurso">
                ...
                <div class="texto_dcha">
                    <p>
                        Las hojas de estilos en cascadas (CSS) son un lenguaje utilizado para describir el aspecto visual de una página web
                    </p>
                    <p>
                        Aprende de verdad a trabajar con HTML y CSS como primer paso para convertirte en un profesional de la Web. Comienza desde cero y domina hasta las últimas novedades en HTML5 y CSS3.
                    </p>
                </div>
            </li>
            <li>
                ...
                <div class="texto_dcha">
                    <ol class="lista_numeros">
                        <li>
                            ...
                            Introducción a CSS3.  Un poco de historia de CSS.

                        </li>
                        <li>

                            Conceptos básicos. Selectores básicos. Selectores Id y Class.

                        </li>
                        <li>

                            Propiedades relacionadas a fuentes, textos. Modelo de Caja y Flexbox 

                        </li>
                        <li>

                            Nuevos estilos. Posicionamiento y Visualización.Animaciones

                        </li>
                        <li>

                            Responsive Design. Librerias y frameworks (Less,...).
