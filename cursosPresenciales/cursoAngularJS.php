<?php include("../include/inc_1_head_inicio_subcarpeta.php") ?>
	...
	<title>AngularJS | Cursos Presenciales | Nuestros cursos | Webstudy.com</title>
...
<div class="destacado_principal slider">
   		...
   		<div class="destacado">
        	...
        	<img alt="" src="../img/imgSlider/angularJs.jpg">
		...
		<div class="contenedor top-block"> 
			<div class="info-box">
                <div class="introCursos row">
                    <p>AngularJS es un framework creado por Google para desarrollar aplicaciones web de alta calidad y en tiempo récord.  </p>
                    <p> En este curso aprenderás a crear tus primeras webapps con AngularJS, descubrirás su configuración, arquitectura y componentes fundamentales y al final del curso habrás creado tu primera aplicación con este potente framework.</p>
                </div>
            </div>
		</div>	
                  ...
                  <div class="texto_dcha">
                      <ol class="lista_numeros">
                          <li>
                               ...
                               Presentación de AngularJS. Qué es AngularJS.
                              
                          </li>
                          <li>
							Instalación de AngularJS. Herramientas de desarrollo con AngularJS
                              
                          </li>
                          <li>
								Expresiones en AngularJS. Insertamos expresiones en AngularJS.Uso de filtros en AngularJS  
                              
                          </li>
                          <li>
								Directivas en AngularJS. Cómo funcionan las directivas.Directivas y estándares web
                              
                          </li>
                           <li>
								Manipulación de datos. Controladores en AngularJS. Listas en AngularJS                              
                          </li>
