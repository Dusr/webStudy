...
(4, 'Javascript desde cero', 'Javascript', '30', 'presencial', 'mayo', 'Curso básico de Javascript donde aprenderas.....'),
(5, 'Prestashop', 'CMS', '40', 'presencial', 'mayo', 'PrestaShop es un gestor de contenidos cms libre, de código abierto compatible con las pasarelas de pago como DirecPay, Google CheckOut, Authorize.net, Moneybookers, PayPal'),
...
(5, 'Curso programación', NULL, '50', 'personalizado', 'todos', 'Necesitas aprender algo nuevo...'),
(6, 'AngularJS', NULL, '50', 'presencial', 'todos', 'Necesitas aprender algo nuevo...'),
(7, 'NodeJS', NULL, '50', 'presencial', 'todos', 'Necesitas aprender algo nuevo...'),
(8, 'Api de facebook', NULL, '50', 'presencial', 'todos', 'Necesitas aprender algo nuevo...'),
(9, 'Para tus empleados', NULL, '50', 'personalizado', 'todos', 'Necesitas formar a tus empleados, llamamos!!'),
(10,'Deseas asesoramiento', NULL, '50', 'personalizado', 'todos', 'Necesitas aprender algo nuevo...'),
(11, 'Miras al futuro', NULL, '50', 'personalizado', 'todos', 'Lenguajes, técnicas, etc...'),
(12, 'Tecnologias', NULL, '50', 'personalizado', 'todos', 'Pregunta tus dudas'),
(13, 'Para tus empleados', NULL, '', 'personalizado', 'todos', NULL);
