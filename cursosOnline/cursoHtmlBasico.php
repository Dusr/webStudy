<?php include("../include/inc_1_head_inicio_subcarpeta.php") ?>
	...
	<title>Curso Html desde cero | Cursos Online | Nuestros cursos | Webstudy.com</title>
		...
		<div class="contenedor top-block"> 
			<div class="info-box">
                <div class="introCursos row">
                    <p>HTML es un lenguaje que utilizan los ordenadores y los programas de diseño, es muy fácil de aprender y escribir por parte de las personas.
                    ...
                    <p>Este curso, estudia a fondo el estándar. Aprenderemos que son las "etiquetas", como se forma una estructura básica con Html, pero siempre siguiendo los estandares.</p>
                </div>
            </div>
		</div>	
		<div class="main inner-block fondoBlanco detalleCurso">
			<ul>
              ...
              <li>
                  ...
                  <div class="texto_dcha">
                      <p><strong>
                        20 horas de dedicación efectiva, incluyendo lecturas, estudio y ejercicios.
                      </strong>
                      </p><p>(se estiman 20 días dedicando 3 horas diarias)</p>
                  </div>
              </li>
              <li>
                  <div class="iconoCurso">
                  ...
                  <div class="texto_dcha">
                      <p>
                          Aprender HTML de <strong>forma sencilla</strong> viendo un concepto teórico, y realizando los ejercicios que hay en cada módulo
                      </p>
                      <p>
                          HTML es un <strong>lenguaje básico</strong> para la creación de páginas web. Es usado para definir la estructutra y el contenido en forma de texto y complementar el texto de páginas web con imágenes, tablas y formularios. Este curso <strong>permite aprender </strong>los fundamentos para la creación de páginas web usando HTML.
                      </p>
                  </div>
              </li>
              <li>
